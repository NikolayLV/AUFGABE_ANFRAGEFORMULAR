		...
		<div class="vacation_block">
			...
			<div class="flatpickr input_section">
				...
				<?php
					...
					echo $this->getTooltip($id = 'reisezeitraum', $tooltipText = 'Geben Sie ein Reisedatum ein.');
				?>
				<script>
					/**
		...
		<div class="contact_block">
			...
			<div class="input_section">
				...
				<?php
					...
					echo $this->getTooltip($id = 'vorname', $tooltipText = 'Gegeben Sie einen gültigen Vorname ein.');
				?>
			</div>
			<div class="input_section">
				...
				<?php
					...
					echo $this->getTooltip($id = 'nachname', $tooltipText = 'Gegeben Sie einen gültigen Nachname ein.');
				?>
			</div>
			<div class="input_section">
				...
				<?php
					...
					echo $this->getTooltip($id = 'geschlecht', $tooltipText = 'Wählen Sie ein Geschlecht aus.');
				?>
			</div>
			<div class="input_section">
				<p class="form_bodytext">E-mail *</p>
				<?php
					echo $this->getInput([
						'type' => 'Email',
						'name' => 'E-mail',
					...
					echo $this->getTooltip($id = 'email', $tooltipText = 'Geben Sie eine gültige E-Mail-Adresse ein.');
				?>
			</div>
			<div class="input_section">
				...
				<?php
					...
					echo $this->getTooltip($id = 'land', $tooltipText = 'Wählen Sie ein Land aus.');
				?>
			</div>
			<div class="input_section">
				...
				<?php
					...
					echo $this->getTooltip($id = 'plz', $tooltipText = 'Geben Sie eine gültige Postleitzahl ein.');
				?>
			</div>
			<div class="input_section">
				...
				<?php
					...
					echo $this->getTooltip($id = 'stadt', $tooltipText = 'Geben Sie eine gültige Stadt ein.');
				?>
			</div>
			<div class="input_section">
				...
				<?php
					...
					echo $this->getTooltip($id = 'strasse', $tooltipText = 'Geben Sie eine gültige Straße ein.');
				?>
			</div>
			<div class="input_section">
